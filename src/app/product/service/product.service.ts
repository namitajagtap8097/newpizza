...
export class ProductService {
  ...
  getProducts():Observable<Product[]>{
    return this.httpClient.get<Product[]>(`${this.uri}`+'/allProduct');
  }
  addProduct(id,name,price){
    ...
    return this.httpClient.post(`${this.uri}`+'/add',prod).subscribe(
          res=>console.log("New Product registered successfull "));
  }
